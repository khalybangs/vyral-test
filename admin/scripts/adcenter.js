$(document).ready(()=>{
    ...
    $('#my-btns7').mouseenter(()=>{
        $('#my-btns7').css('background-color', '#f9f9f9');
        $('#my-btns7').css('color', 'orange');
    });
    $('#my-btns8').mouseenter(()=>{
        $('#my-btns8').css('background-color', '#f9f9f9');
        $('#my-btns8').css('color', 'orange');
    });
    $('#my-btns1').mouseleave(()=>{
        if (curbtn == 'btn1') {
    ...
    $('#my-btns7').mouseleave(()=>{
        if (curbtn == 'btns7') {
            ...
            $('#my-btns7').css('background-color', 'transparents');
            $('#my-btns7').css('color', 'white');
        }
    });
    $('#my-btns8').mouseleave(()=>{
        if (curbtn == 'btns8') {
            $('#my-btns8').css('background-color', 'white');
            $('#my-btns8').css('color', 'darkorange');
        }else {
            $('#my-btns8').css('background-color', 'transparents');
            $('#my-btns8').css('color', 'white');
        }
    });
    //click effects
    $('#my-btns1').click(()=>{
        ...
        $('#my-btns1').css('background-color', 'white');
        $('#my-btns1').css('color', 'darkorange');
        $('#my-btns2, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('color', 'white');
        // dis/appear
        $('#userFlw, #autFlw, #repFlw, #wrtFlw, #admnFlw, #subFlw, #appICont').css('display', 'none');
        $('#homeFlw').fadeIn();
        getInfo();
    });
    $('#my-btns2').click(()=>{
        ...
        $('#my-btns2').css('background-color', 'white');
        $('#my-btns2').css('color', 'darkorange');
        $('#my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('color', 'white');
        $('#homeFlw, #autFlw, #repFlw, #wrtFlw, #admnFlw, #subFlw, #appICont').css('display', 'none');
        $('#userFlw').fadeIn();
        getUsers();
    });
    $('#my-btns3').click(()=>{
        ...
        $('#my-btns3').css('background-color', 'white');
        $('#my-btns3').css('color', 'darkorange');
        $('#my-btns2, #my-btns1, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns1, #my-btns4, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('color', 'white');
        $('#homeFlw, #userFlw, #repFlw, #wrtFlw, #admnFlw, #subFlw, #appICont').css('display', 'none');
        $('#autFlw').fadeIn();
        getAUthors();
    });
    $('#my-btns4').click(()=>{
        ...
        $('#my-btns4').css('background-color', 'white');
        $('#my-btns4').css('color', 'darkorange');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns5, #my-btns6, #my-btns7, #my-btns8').css('color', 'white');
        $('#homeFlw, #userFlw, #autFlw, #wrtFlw, #admnFlw, #subFlw, #appICont').css('display', 'none');
        $('#repFlw').fadeIn();
        getReprts();
    });
    $('#my-btns5').click(()=>{
        ...
        $('#my-btns5').css('background-color', 'white');
        $('#my-btns5').css('color', 'darkorange');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns4, #my-btns6, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns4, #my-btns6, #my-btns7, #my-btns8').css('color', 'white');
        $('#homeFlw, #userFlw, #autFlw, #repFlw, #admnFlw, #subFlw, #appICont').css('display', 'none');
        $('#wrtFlw').fadeIn();
        getUpdtes();
    });
    $('#my-btns6').click(()=>{
        ...
        $('#my-btns6').css('background-color', 'white');
        $('#my-btns6').css('color', 'darkorange');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns4, #my-btns5, #my-btns7, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns3, #my-btns1, #my-btns4, #my-btns5, #my-btns7, #my-btns8').css('color', 'white');
        $('#homeFlw, #userFlw, #autFlw, #repFlw, #wrtFlw, #subFlw, #appICont').css('display', 'none');
        $('#admnFlw').fadeIn();
        getAllAdmins();
    });
    $('#my-btns7').click(()=>{
        ...
        $('#my-btns7').css('background-color', 'white');
        $('#my-btns7').css('color', 'darkorange');
        $('#my-btns2, #my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns8').css('background-color', 'transparent');
        $('#my-btns2, #my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns8').css('color', 'white');
        // dis/appear
        $('#userFlw, #autFlw, #repFlw, #wrtFlw, #admnFlw, #homeFlw, #appICont').css('display', 'none');
        $('#subFlw').fadeIn();
        getSubscrpt();
    });
    $('#my-btns8').click(()=>{
        ...
        $('#my-btns8').css('background-color', 'white');
        $('#my-btns8').css('color', 'darkorange');
        $('#my-btns2, #my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7').css('background-color', 'transparent');
        $('#my-btns2, #my-btns1, #my-btns3, #my-btns4, #my-btns5, #my-btns6, #my-btns7').css('color', 'white');
        // dis/appear
        $('#userFlw, #autFlw, #repFlw, #wrtFlw, #admnFlw, #homeFlw, #subFlw').css('display', 'none');
        $('#appICont').fadeIn();
        getAppInfo();
    });
    ...
    const getAppInfo = () => {
        ...
        fetch('/getGlbCol', {
            ...
            // change status
            const changeGlob = (stat) => {
                fetch('/adcenter/edtGlobal', {
                    method: 'post',
                    body: JSON.stringify({ edt: {status: stat}, id: glob._id }),
                    headers : {
                        "Content-type" : "application/json; charset=utf-8"
                    } 
                }).then((response)=>{
            ...
            $('#chngAVNBtn').click(()=>{
                if ($('#avnIN').val() !== '') {
                    fetch('/adcenter/edtGlobal', {
                        method: 'post',
                        body: JSON.stringify({ edt: {app_no: $('#avnIN').val()}, id: glob._id }),
                        headers : {
                            "Content-type" : "application/json; charset=utf-8"
                        } 
                    }).then((response)=>{
                    ...
                    alert('insert the latest application version number, precisely!');
                }
            });
        ...
        const infoNow = () => {
            fetch('/getGlbCol', {
                ...
                // status
                if (glob.status == 'active') {
                    $('#appStatusP').text('active');
                    $('#statAct').css('display', 'none');
                    $('#statBusy').fadeIn();
                } else {
                    $('#appStatusP').text('busy');
                    $('#statBusy').css('display', 'none');
                    $('#statAct').fadeIn();
                }
                $('#appStatusP').text(glob.status);
                // version
                $('#verNoApp').text(glob.app_no);
            });
        }
        infoNow();
    }
